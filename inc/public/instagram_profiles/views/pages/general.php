<div class="widget-box-add-account">
	...
	<?php _e('*If you have 2-Factor Authentication enabled on your Instagram account, please use the Text verification and turn off the 3rd-party verification methods. This will cause connection errors.') ?>
