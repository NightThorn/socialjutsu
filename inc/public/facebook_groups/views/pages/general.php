<div class="widget-box-add-account">
	...
	<div class="note">
		<div class="desc m-b-15"><?php _e("If you don't see your profiles above, make sure that you are a Group Admin of the group, and that the SocialJutsu App has been added to your group as an allowed App.") ?><a href="https://socialjutsu.com/blog/how-to-allow-socialjutsu-to-post-to-your-facebook-group">Add an app to Facebook Group</a></div>
