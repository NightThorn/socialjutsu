...
$lang["Retweeters"] = "Retweeters";
$lang["My posts"] = "My posts";
$lang["Favorites/hour"] = "Favorites/hour";
$lang["Reply/hour"] = "Reply/hour";
$lang["Retweets/day"] = "Retweets/day";
$lang["Min. favorites filter"] = "Min. favorites filter";
$lang["Max. favorites filter"] = "Max. favorites filter";
$lang["Min. retweets filter"] = "Min. retweets filter";
$lang["Max. retweets filter"] = "Max. retweets filter";
$lang["Enter your reply"] = "Enter your reply";
$lang["Enter list hashtags separated by line breaks"] = "Enter list hashtags separated by line breaks";
$lang["Enter list keyword separated by line breaks"] = "Enter list keyword separated by line breaks";
$lang["Favorites counter"] = "Favorites counter";
$lang["Replies counter"] = "Replies counter";
$lang["Retweets counter"] = "Retweets counter";
$lang["Based on selected Activity Actions, you can like and/or comment on media posted under <b>Keywords</b> added in your settings, and/or follow users who posted those media.<br/><br/> <span class='text-info'>INFO:</span> This targeting source works independently of all other targeting sources that you can select.<br/><br/> <span class='text-warning'>IMPORTANT:</span> To use this source you should add at least 1 Keyword in the <b>Keywords</b> list."] = "Based on selected Activity Actions, you can like and/or comment on media posted under <b>Keywords</b> added in your settings, and/or follow users who posted those media.<br/><br/> <span class='text-info'>INFO:</span> This targeting source works independently of all other targeting sources that you can select.<br/><br/> <span class='text-warning'>IMPORTANT:</span> To use this source you should add at least 1 Keyword in the <b>Keywords</b> list.";
$lang["Based on selected Activity Actions, you can follow users who have liked the media posted by the <b>Usernames</b> added in your settings, and/or like or comment on 1-3 most recent media posted by those users.<br/> You can also target your own Likers (users who have liked your media) by selecting <b>My posts</b> or <b>All</b>.<br/><br/> <span class='text-info'>INFO:</span> This targeting source works independently of all other targeting sources that you can select.<br/><br/> <span class='text-warning'>IMPORTANT:</span> To use this source you may need to add at least 2 usernames in the <b>Usernames</b> list."] = "Based on selected Activity Actions, you can follow users who have liked the media posted by the <b>Usernames</b> added in your settings, and/or like or comment on 1-3 most recent media posted by those users.<br/> You can also target your own Likers (users who have liked your media) by selecting <b>My posts</b> or <b>All</b>.<br/><br/> <span class='text-info'>INFO:</span> This targeting source works independently of all other targeting sources that you can select.<br/><br/> <span class='text-warning'>IMPORTANT:</span> To use this source you may need to add at least 2 usernames in the <b>Usernames</b> list.";
$lang["Number of favorite actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>60</b><br/><br/><span class='text-danger'>Use with caution!</span>"] = "Number of favorite actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>60</b><br/><br/><span class='text-danger'>Use with caution!</span>";
$lang["Number of reply actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>20</b><br/><br/><span class='text-danger'>Use with caution!</span>"] = "Number of reply actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>20</b><br/><br/><span class='text-danger'>Use with caution!</span>";
$lang["Number of retweet actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>20</b><br/><br/><span class='text-danger'>Use with caution!</span>"] = "Number of retweet actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>20</b><br/><br/><span class='text-danger'>Use with caution!</span>";
$lang["Number of Unfollow actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>40</b><br/><br/><span class='danger'>Use with caution!</span>"] = "Number of Unfollow actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>40</b><br/><br/><span class='danger'>Use with caution!</span>";
$lang["Welcome DM/hour"] = "Welcome DM/hour";
$lang["When this number of replies will be done your activity will be stopped automatically. Set to zero to disable the limit."] = "When this number of replies will be done your activity will be stopped automatically. Set to zero to disable the limit.";
$lang["Replies counter"] = "Replies counter";
$lang["Format: HH:MM. For example, if you set it to <b>01:00</b>, then your activity will stop automatically after one hour. If you leave it empty, then activity will work infinite or while Twitter limits for your account not will be reached."] = "Format: HH:MM. For example, if you set it to <b>01:00</b>, then your activity will stop automatically after one hour. If you leave it empty, then activity will work infinite or while Twitter limits for your account not will be reached.";
$lang["Reply action"] = "Reply action";
$lang["Favorite action"] = "Favorite action";
$lang["Total of favorite actions"] = "Total of favorite actions";
$lang["Total of reply actions"] = "Total of reply actions";
$lang["Retweet action"] = "Retweet action";
$lang["Total of retweet actions"] = "Total of retweet actions";
$lang["Welcome DM action"] = "Welcome DM action";
$lang["Total of welcome DM actions"] = "Total of welcome DM actions";
$lang["Twitter activity"] = "Twitter activity";
$lang["Welcome DM"] = "Welcome DM";
...
$lang["Don't reply same users"] = "Don't reply same users";
$lang["When checking this box you will not reply more than one media of the same user."] = "When checking this box you will not reply more than one media of the same user.";
$lang["Enter your reply"] = "Enter your reply";
$lang["Add at least one reply if you are turned on replies in your to do section."] = "Add at least one reply if you are turned on replies in your to do section.";
$lang["Replies"] = "Replies";
...
$lang["Videos"] = "Videos";
$lang["Min. favorites filter"] = "Min. favorites filter";
$lang["Interact only with media that have minimum selected amount of favorites.<br/><br/>Use it along with <b>Max. favorites filter</b> to set desired range of media popularity.<br/><br/>Recommended value: 0.<br/><br/>Set to zero to disable this filter."] = "Interact only with media that have minimum selected amount of favorites.<br/><br/>Use it along with <b>Max. favorites filter</b> to set desired range of media popularity.<br/><br/>Recommended value: 0.<br/><br/>Set to zero to disable this filter.";
$lang["Max. favorites filter"] = "Max. favorites filter";
$lang["Interact only with media that have maximum selected amount of favorites.<br/><br/>Use it along with <b>Min. favorites filter</b> to set desired range of media popularity.<br/><br/>Recommended values: 50-100.<br/><br/>Set to zero to disable this filter."] = "Interact only with media that have maximum selected amount of favorites.<br/><br/>Use it along with <b>Min. likes filter</b> to set desired range of media popularity.<br/><br/>Recommended values: 50-100.<br/><br/>Set to zero to disable this filter.";
$lang["Min. retweets filter"] = "Min. retweets filter";
$lang["Interact only with media that have minimum selected amount of retweets.<br/><br/>Use it along with <b>Max. retweets filter</b> to set desired range of media popularity.<br/><br/>Recommended value: 0.<br/><br/>Set to zero to disable this filter."] = "Interact only with media that have minimum selected amount of retweets.<br/><br/>Use it along with <b>Max. retweets filter</b> to set desired range of media popularity.<br/><br/>Recommended value: 0.<br/><br/>Set to zero to disable this filter.";
$lang["Max. retweets filter"] = "Max. retweets filter";
$lang["Interact only with media that have maximum selected amount of retweets.<br/><br/>Use it along with <b>Min. retweets filter</b> to set desired range of media popularity.<br/><br/>Recommended values: 20-50.<br/><br/>Set to zero to disable this filter."] = "Interact only with media that have maximum selected amount of retweets.<br/><br/>Use it along with <b>Min. retweets filter</b> to set desired range of media popularity.<br/><br/>Recommended values: 20-50.<br/><br/>Set to zero to disable this filter.";
...
$lang["Number of Welcome DM actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>20</b><br/><br/><span class='text-danger'>Use with caution!</span>"] = "Number of Welcome DM actions that your activity will try to post in an hour.<br/><br/>Allowed values: <b>1</b>-<b>20</b><br/><br/><span class='text-danger'>Use with caution!</span>";
...
$lang["Favorites counter"] = "Favorites counter";
$lang["When this number of favorites will be done your activity will be stopped automatically. Set to zero to disable the limit."] = "When this number of favorites will be done your activity will be stopped automatically. Set to zero to disable the limit.";
$lang["Retweets counter"] = "Retweets counter";
$lang["When this number of retweets will be done your activity will be stopped automatically. Set to zero to disable the limit."] = "When this number of retweets will be done your activity will be stopped automatically. Set to zero to disable the limit.";
...
$lang["Welcome DM counter"] = "Welcome DM counter";
$lang["When this number of Welcome DM will be done your activity will be stopped automatically. Set to zero to disable the limit."] = "When this number of Welcome DM will be done your activity will be stopped automatically. Set to zero to disable the limit.";
...
$lang["Turn this switch on to automate your favorites activity.<br/><br/> The counter shows how many medias you've favorited since your last activity start."] = "Turn this switch on to automate your favorites activity.<br/><br/> The counter shows how many medias you've favorited since your last activity start.";
$lang["Turn this switch on to automate your replies activity.<br/><br/> The counter shows how many tweets you've replied since your last activity start."] = "Turn this switch on to automate your replies activity.<br/><br/> The counter shows how many tweets you've replied since your last activity start.";
$lang["Turn this switch on to automate your retweets activity.<br/><br/> The counter shows how many tweets you've retweeted since your last activity start."] = "Turn this switch on to automate your retweets activity.<br/><br/> The counter shows how many tweets you've retweeted since your last activity start.";
