		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="tw-ac-option wrap-m">
				...
				<div class="action wrap-c">
					...
					<option <?php twav($a, "unfollows", "source", "all") ?> value="all"><?php _e("All")?></option>
  					<option <?php twav($a, "unfollows", "source", "db") ?> value="db" selected=""><?php _e("Our source")?></option>
  				</select>
				</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="tw-ac-option wrap-m">
				...
				<div class="action wrap-c">
					...
					<option <?php twav($a, "unfollows", "after", "1") ?> value="1"><?php _e("1")?></option>
  					<option <?php twav($a, "unfollows", "after", "2") ?> value="2"><?php _e("2")?></option>
  					<option <?php twav($a, "unfollows", "after", "3") ?> value="3"><?php _e("3")?></option>
  					<option <?php twav($a, "unfollows", "after", "4") ?> value="4"><?php _e("4")?></option>
  					<option <?php twav($a, "unfollows", "after", "5") ?> value="5"><?php _e("5")?></option>
  					<option <?php twav($a, "unfollows", "after", "6") ?> value="6"><?php _e("6")?></option>
  					<option <?php twav($a, "unfollows", "after", "7") ?> value="7"><?php _e("7")?></option>
  				</select>
				</div>
		...
		<div class="col-md-4 col-sm-6 m-b-25">
			<div class="tw-ac-option wrap-m">
				...
				<div class="action wrap-c">
					...
					<input type="checkbox" class="action-save" name="unfollows[dont_follower]" <?php twav($a, "unfollows", "dont_follower") ?> value="1"><span></span>
				</label>
				</div>
			</div>
		</div>
