<div class="tab-pane fade" id="v-pills-blacklist" role="tabpanel" aria-labelledby="v-pills-blacklist-tab">
	...
	<div class="m-b-25">
		<div class="list-add-blacklist-tag">
			...
			<div class="tw-ac-tab-full m-b-25">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
				  	<li class="nav-item">
				    	<a class="nav-link active" id="blacklist-tag-list-tab" data-toggle="tab" href="#blacklist-tag-list" role="tab" aria-controls="blacklist-tag-list" aria-selected="false"><?php _e("Add list tags")?></a>
				  	</li>
				</ul>
				<div class="tab-content" id="myTabContent">
				  	<div class="tab-pane fade show active" id="blacklist-tag-list" role="tabpanel" aria-labelledby="blacklist-tag-list-tab">
