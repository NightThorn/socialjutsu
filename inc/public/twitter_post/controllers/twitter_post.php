...
class twitter_post extends MY_Controller {
	...
	public function index($page = "", $ids = "")
	{
		...
		$views = [
			...
			"column_two" => view("pages/general", [ 'file_manager_photo' => $block_file_photo, 'file_manager_video' => $block_file_video, 'block_post_type' => $block_post_type, 'block_link' => $block_link, 'block_caption' => $block_caption, 'block_schedule' => $block_schedule, 'idea' => $idea ] ,true), 
