<select name="ids" class="cd-select tw-dm-select" data-select-account="<?php _e("Select an account")?>"  data-keyword-search="<?php _e("Enter keyword")?>">
...
<div class="widget">
	...
	<div class="widget-list search-list tw-dm-list">
		<?php _e( $list, false )?>
	</div>
