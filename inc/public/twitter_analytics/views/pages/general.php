	...
	<div class="wrap-analytics" id="wrap-analytics">
		<div class="profile-info m-t-25">
			...
			<div class="info">
				...
				<ul class="stats">
					<li><?php _e(sprintf(__("%s posts"), number_format($profile_info->statuses_count))) ?></li>
					<li><?php _e(sprintf(__("%s followers"), number_format($profile_info->followers_count))) ?></li>
					<li><?php _e(sprintf(__("%s following"), number_format($profile_info->friends_count))) ?></li>
				</ul>
				<div class="fullname"><?php _e("@" . $profile_info->screen_name) ?></div>
				<div class="description"><?php _e($profile_info->description) ?></div>
				<div class="website"><a class="text-info" href="<?php _e($profile_info->url) ?>" target="_blank"><?php _e($profile_info->url) ?></a></div>
			</div>
		</div>
		...
		<ul class="box-sumary m-t-25">
			...
			<li>
				<div>
					<span><?php _e($account_data->average_comments) ?></span><?php _e("Average Retweets") ?>
					<i class="activity-option-help webuiPopover fa fa-question-circle" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="<?php _e("Average retweets based on the last 10 posts") ?>"></i>
				</div>
			</li>
